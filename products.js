...
const PRODUCTS = [
    ...
    { id: 'GEXUFNZG2DGXANGXSYTKRSII', name: 'Wholesale 1-2pc Sports Hijab', variation: 'Regular', price: 8.00, category: 'hijab', description: '' },
    { id: '3IESQNLHDZA4RKRUA7O6VJHC', name: 'Wholesale Abaya', variation: 'Regular', price: 27.00, category: 'abaya', description: '' },
    { id: 'CRZ6DHYGUFCTP7VBGH5HONIG', name: 'Wholesale Cotton LS', variation: 'Regular', price: 11.20, category: 'uniform', description: '' },
    { id: '4UAK3U5MAEM7AR5MGKZCD7CP', name: 'Wholesale Cotton LS-Bayaan', variation: 'Regular', price: 12.80, category: 'uniform', description: '' },
    { id: 'GXPYRRJHORK22UNPGLAXO5WE', name: 'Wholesale Cotton SS', variation: 'Regular', price: 9.60, category: 'uniform', description: '' },
    { id: 'OF3QC7BCCJ2RAG7RQJYUYAVX', name: 'Wholesale Cotton SS-Bayaan', variation: 'Regular', price: 12.00, category: 'uniform', description: '' },
    { id: 'H2OGQWOJ24OOXTCEXMG32TGO', name: 'Wholesale Instant Hijab', variation: 'Regular', price: 9.75, category: 'hijab', description: '' },
    { id: 'JAZGL7HN7SE22DMYFSUH266X', name: 'Wholesale Magnets', variation: 'Regular', price: 1.50, category: 'hijab', description: '1 set' },
    { id: 'HYD3LOTUIMLOQ5B3F26SR2KF', name: 'Wholesale PE Tunic', variation: 'Regular', price: 27.00, category: 'tunic', description: '' },
    { id: 'HKIUBKO4DQQN5EXCZCVBSM77', name: 'Wholesale Performance LS', variation: 'Regular', price: 12.80, category: 'uniform', description: '' },
    { id: '66YUV6RKDANGJPAMJP2HGHPI', name: 'Wholesale Performance SS', variation: 'Regular', price: 11.20, category: 'uniform', description: '' },
    { id: 'UVX233BW7MVNMMTLWY63CEII', name: 'Wholesale Polo Adult SS', variation: 'Regular', price: 18.70, category: 'uniform', description: '' },
    { id: '5SCN5VSIHSLRMFHBLNK5JJJ3', name: 'Wholesale Polo Performance Limited - Youth', variation: 'Regular', price: 15.00, category: 'uniform', description: 'Special discount for limited time' },
    { id: 'XK55ZFOPDUWGVCNKRWG2XSA6', name: 'Wholesale Polo Yth SS', variation: 'Regular', price: 17.85, category: 'uniform', description: '' },
    { id: 'T3RJKD2JUDPHROVZEYYOC4KD', name: 'Wholesale Straight Pins', variation: 'Regular', price: 2.00, category: 'hijab', description: '1 roll' },
    { id: '2SJRFYXNHMG5QJPWSNLR4BEB', name: 'Wholesale Tunic', variation: 'Regular', price: 23.80, category: 'tunic', description: '' },
    { id: '63TNFRC3Y2QJH7WZW4APLKRP', name: 'Wholesale Undercap', variation: 'Regular', price: 2.00, category: 'hijab', description: '' },
    { id: 'L2JVT7GXIXUITR23RH6QIEET', name: 'Wholesale Zip Hoodie -Adult', variation: 'Regular', price: 27.20, category: 'uniform', description: '' },
    { id: 'GVPSC6DBWN3IERMTUV5RIJTW', name: 'Wholesale Zip Hoodie -youth', variation: 'Regular', price: 24.00, category: 'uniform', description: '' },
    { id: '5U27MCRMQCAIX4U3ZDJG7D7G', name: 'Wholesale Zip Hoodie XXL', variation: 'Regular', price: 28.80, category: 'uniform', description: '' }
];
